...
import service.RepairHomeService;
 ...
 * @author IkraBagwan
 */
public class RepairHome extends javax.swing.JFrame {

    /**
     * Creates new form RepairHome
     */
     String name;
    ObjectId userId;
    RepairHomeService service = new RepairHomeService();
    ArrayList<Document> records;
    int row = -1;
    public RepairHome(String name, ObjectId userId) throws ParseException {
        initComponents();
...
//        pack();
          ...
          orderTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    // When the user finishes selecting a row
                    row = orderTable.getSelectedRow();

                    // Check if a row is selected
                    if (row >= 0) {
                        deleteBtn.setEnabled(true); // Enable the delete button
                    } else {
                        deleteBtn.setEnabled(false); // Disable the delete button
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        searchBy.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Plane Number", "Date", "Order Status", "Given By", "Due Date" }));

        searchBtn.setFont(new java.awt.Font("Dubai", 1, 14)); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/repair.jpg"))); // NOI18N
    ...
    private void newOrderBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_newOrderBtnMouseClicked
        ...
        AddRepairOrder aeo = new AddRepairOrder(this.userId, service.getArrayData());
    ...
    private void updateStatusBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateStatusBtnMouseClicked
        ...
        if(row > -1){
            ...
            System.out.println(row +" "+records.get(row).get("_id"));

            RepairStatus os = new RepairStatus((ObjectId) records.get(row).get("_id"));
    ...
    private void refreshBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_refreshBtnMouseClicked
        ...
        service = new RepairHomeService();
        try {
            fillTable();
        } catch (ParseException ex) {
            Logger.getLogger(RepairHome.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void deleteBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBtnMouseClicked
        // TODO add your handling code here:
         if (row >= 0) {
        // Use the 'row' variable to get the selected row index
        ObjectId selectedOrderId = (ObjectId) records.get(row).get("_id");

        // Perform your delete logic here
        // Example: service.deleteOrder(selectedOrderId);
